...
export function PostContent({ htmlContent }: PostContentProps) {
  ...
  useEffect(() => {
    ...
    // Track roots created in this effect for cleanup
    const roots: any[] = [];
    let isMounted = true;
    ...
    return () => {
      ...
      // Cleanup all roots created in this effect
      roots.forEach((root) => {
        // Use setTimeout to avoid synchronous unmounting issues during render cycles
